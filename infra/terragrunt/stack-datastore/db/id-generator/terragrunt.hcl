...
include "shared" {
  path = "${get_terragrunt_dir()}/../../../_shared/_components/id-generator.hcl"  # Path to the shared component configuration
  expose = true  # Exposes the included configuration to child modules
...
locals {
  ...
  terraform_modules_local_path = "../../../../terraform/id-generator"  # Local path to the Terraform module
  ...
  # - If no remote path is provided, it uses the local path combined with the module name (e.g., "id-generator").
